...
with open(r"/ifs1/User/maiguoqin/pathogen/国家病原库基因组/bacteria_virus_funge_para_arm/test2_hebing/code/blastn_list.txt") as dff:
    d=dff.readlines()
    for name in d:
        fpath = (r"/ifs1/User/maiguoqin/pathogen/国家病原库基因组/bacteria_virus_funge_para_arm/test2_hebing/6_blastn/%s.fastq.gz.txt"%(name.split(".")[0]))
        ...
        df.to_csv(r"/ifs1/User/maiguoqin/pathogen/国家病原库基因组/bacteria_virus_funge_para_arm/test2_hebing/7_count/%s.csv"%(name.split(".")[0]))
